# nvim-treesitter-queries-hurl

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-hurl/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-hurl/actions/workflows/validate.yml)

Neovim tree-sitter queries for **hurl**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-hurl",
...
- [ ] Changes are scoped to `hurl` — do not include files for other languages
